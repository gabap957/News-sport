    ...
    <div class="main ">
        <div class="container a-container" id="a-container">
            <form action="{{route('admin.login')}}" class="form" id="b-form" method="post">
                ...
                </div><span class="form__span">Hoặc sử dụng tài khoản email của bạn</span>
                <input class="form__input" type="text" name="email" placeholder="Email" required>
                <input class="form__input" name="password" type="password" placeholder="Password" required><a
        ...
        <div class="switch" id="switch-cnt">
            ...
            <div class="switch__container is-hidden" id="switch-c2">
                ...
                <p class="switch__description description">Để duy trì kết nối với chúng tôi vui lòng đăng nhập bằng thông tin cá nhân của bạn</p>
