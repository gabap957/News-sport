...
<div class="card shadow mb-4 min-height-card">
    <div class="card-header py-3">
        <div>
            <h6 class="m-0 font-weight-bold text-primary">Kho ảnh</h6>
        </div>
        <div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-2 text-center" onclick="window.location='{{ URL::route('admin.image.list')}}'">
                <div class="box-album">
                    <div class="backgroud-album">
                        <div class="box-album-image">
                            <div class="img-folder"><img src="https://img.icons8.com/3d-fluency/94/folder-invoices--v1.png"
                                alt="folder-invoices--v1" /></div>
                            <div class="icon-button">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    version="1.1" x="0px" y="0px" viewBox="0 0 20 25" enable-background="new 0 0 20 20"
                                    xml:space="preserve">
                                    ...
                                    <text x="0" y="35" fill="#000000" font-size="5px" font-weight="bold"
                                        ...
                                        by AS Design</text><text x="0" y="40" fill="#000000" font-size="5px"
                                        font-weight="bold"
